...
*/
template<class T> void LinkedList<T>::insert_node(T value)
{
	auto *temp = new node;
	temp->data = value;
	temp->next = nullptr;
...
/**
	...
	@param value The value to be inserted.
*/
template<class T> void LinkedList<T>::insert_start(T value)
{
	auto *temp = new node;
	temp->data = value;
	temp->next = head;
...
/**
	...
	@param value The value to be inserted.
*/
template<class T> void LinkedList<T>::insert_position(T value, T pos)
{
	auto *previous = new node;
	auto *temp = new node;
...
*/
template<class T> void LinkedList<T>::delete_first()
{
	auto *temp = nullptr;
	temp = head;
	head = head->next;
...
*/
template<class T> void LinkedList<T>::delete_position(T pos)
{
